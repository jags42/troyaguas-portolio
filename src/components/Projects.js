    ...
    <section id="projects" className="py-20 px-6 text-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-10">
          {/* Mindgrasp */}
          <a
            href="https://www.mindgrasp.ai/"
            target="_blank"
            rel="noopener noreferrer"
            className="block"
          >
            <div className="bg-primary border border-border rounded-lg shadow-md hover:-translate-y-1 hover:shadow-xl transition cursor-pointer">
              <div className="project-content flex gap-8 max-md:flex-col">
                <div className="project-image w-1/4 max-md:w-full">
                  <img
                    ...
                    className="h-full w-full object-cover rounded-md shadow-md border border-border block"
                  />
                </div>
                ...
                <div className="project-text p-6 w-3/4 max-md:w-full">
                  ...
                  <ul className="list-disc ml-5 text-gray-400 mb-4 space-y-1">
              ...
              <div className="project-content flex gap-8 max-md:flex-col">
                <div className="project-image max-md:w-full">
                  <img
                    ...
                    className="h-full w-full object-cover object-left rounded-md shadow-md border border-border block"
                  />
                </div>
              ...
              <div className="project-content flex gap-8 max-md:flex-col">
                <div className="project-image max-md:w-full">
                  <img
                    ...
                    className="h-full w-full object-cover object-center rounded-md shadow-md border border-border block"
                  />
                </div>
